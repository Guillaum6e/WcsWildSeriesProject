 ...
 */
final class Version20221121135848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT NOT NULL, CHANGE year year INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season DROP program_id, CHANGE year year VARCHAR(4) DEFAULT NULL');
    }
}
